  ...
  <div class="chat-header relative flex min-h-14 items-center justify-between px-4 pb-2.5 pt-3 text-white sm:px-5">
    <div class="flex min-w-0 flex-1 items-center gap-2 sm:gap-2.5">
      <svg
        ...
        class="h-9 w-9 shrink-0 rounded-xl bg-white p-1.5 shadow-md motion-safe:animate-soft-float sm:h-10 sm:w-10"
        style="fill: #6d4fc2"
      >
      ...
      <div class="flex min-w-0 flex-col">
        ...
        <span class="truncate text-[10px] font-medium text-white/70 sm:text-[11px]">Powered by Gemini</span>
      </div>
    </div>
